...
namespace Semafone.Json
{
    ...
    public class PciElement
    {
        ...
        string _panlength = "";
        [JsonProperty(PropertyName = "panLength")]
        public string PanLength { get { return _panlength; } set { _panlength = value; } }

        string _cvclength = "";
        [JsonProperty(PropertyName = "cvcLength")]
        public string CvcLength { get { return _cvclength; } set { _cvclength = value; } }

        string _issuenoreq = "";
        [JsonProperty(PropertyName = "issueNoReq")]
        public string IssueNoReq { get { return _issuenoreq; } set { _issuenoreq = value; } }

        string _validfromreq = "";
        [JsonProperty(PropertyName = "validFromReq")]
        public string ValidFromReq { get { return _validfromreq; } set { _validfromreq = value; } }
